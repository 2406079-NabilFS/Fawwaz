    ...
    try:
        ...
        if label:
            ...
            for cls in config['classes']:
                prob = probs[cls]
                color_map = {'rock': '#e74c3c', 'paper': '#2ecc71', 'scissors': '#3498db'}
...
# ==================== INFO ====================
st.markdown("---")
st.markdown("**Dibangun dengan:**")
st.write("- PyTorch CNN untuk ekstraksi fitur")
st.write("- Dataset: 2,520 gambar (Rock-Paper-Scissors)")
st.write("- Akurasi validation: 100%")
